...
public class ViewPersonsList extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private Button saveWithoutRenaming_button;
                        ...
                        if (personsProfileInfo != null) {
                            ...
                            runOnUiThread(() -> {
                                ...
                                if (result) {//was added properly
                                    ProfileEntity newProfile = new ProfileEntity(personsProfileInfo.getName(), personsProfileInfo.getURL(), currentSession.id, personsProfileInfo.getCommonCourses(), personsProfileInfo.getUniqueId(), personsProfileInfo.getIsWaving());
    ...
    public void saveSessionDialog(){
        ...
        saveWithoutRenaming_button = (Button) saveSessionPopupView.findViewById(R.id.save_without_changing_name);
        ...
        saveWithoutRenaming_button.setOnClickListener(new View.OnClickListener() {
              @Override
        ...
        continueButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for (ProfileInfo newProfile : loadedProfiles) {
                    ...
                    Log.i(TAG, newProfile.getCommonCourses().toString());
